...
>>>>>>> 3aaac9d4878a04cbffbc6e1fe715469f4fbe6a56
                </>
              )}
...
<<<<<<< HEAD
                ...
                <div
                  style={{ textAlign: "left", fontWeight: 400, fontSize: "16px", lineHeight: '20px', }}
                >
                ...
                <s.TextAlign style={{ marginBottom: '0', }}>성별</s.TextAlign>
                <div style={{
                    display: 'flex',
                  ...
                  <s.OtherRadio
                    ...
                    value="male"
                    checked={gender === 'male'}
                    onChange={() => setGender('male')}/>남성</s.OtherLavel>
                  ...
                  <s.OtherRadio
                    ...
                    onChange={() => setGender('female')}/>여성</s.OtherLavel>
                  ...
                  <s.OtherRadio
                    ...
                    onChange={() => setGender('other')}/>둘 다 아님</s.OtherLavel>

                  {gender === 'other' && (
                    <div style={{ display:'wrap', flexDirection: 'wrap', justifyContent: 'flex-end', }}>
                        <s.Input
                            maxLength={500}
                            ...
                            />
                        <div style={{ fontSize: "12px", marginTop: '10px' }}>{customGender.length}/500</div>
                    </div>
                  )}                
            </div>
